...
import {setStreakAfterLesson, fetchUserDetails, loginUser, logoutUser, registerUser, setLastLessonDate, uploadAvatar, checkStreak, rankList, findUserByName} from "../controllers/user.controller.js";
...
useRouter.post('/name-find', auth, findUserByName)
